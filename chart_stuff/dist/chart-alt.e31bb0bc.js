...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/styles_doc.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/styles_chartAlt.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
},{}],"src/barChart.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.coffeeChart_full = exports.coffeeChart_1_12 = exports.coffeeChart_2_6 = exports.coffeeChart = exports.coffeeChart_1_4 = exports.coffeeChart_2_1 = void 0;
...
var hot = _patternomaly.default.draw("zigzag", "rgba(140, 127, 114, 0.4)");

var iced = _patternomaly.default.draw("dot", "rgba(112, 91, 58, 0.4)"); // Chart object data
// 2 datasets, 1 label
...
exports.coffeeChart_2_1 = coffeeChart_2_1;
var coffeeChart_1_4 = {
  type: "bar",
  data: {
...
exports.coffeeChart_1_4 = coffeeChart_1_4;
var coffeeChart = {
  type: "bar",
  data: {
    labels: ["January", "February", "March", "April"],
...
exports.coffeeChart = coffeeChart;
var coffeeChart_2_6 = {
  type: "bar",
  data: {
...
exports.coffeeChart_2_6 = coffeeChart_2_6;
var coffeeChart_1_12 = {
  type: "bar",
  data: {
    labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
    datasets: [{
      label: "Hot",
      data: [19, 22, 16, 9, 7, 4, 4, 4, 6, 8, 15, 18],
      backgroundColor: hot
    }]
  },
  options: {
...
exports.coffeeChart_1_12 = coffeeChart_1_12;
var coffeeChart_full = {
  type: "bar",
  data: {
    labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
    datasets: [{
      label: "Hot",
      data: [19, 22, 16, 9, 7, 4, 4, 2, 6, 8, 15, 18],
      backgroundColor: hot
    }, {
      label: "Iced",
      data: [12, 10, 15, 21, 19, 22, 26, 29, 24, 20, 15, 9],
      backgroundColor: iced
    }]
  },
  options: {
...
exports.coffeeChart_full = coffeeChart_full;
},{"patternomaly":"node_modules/patternomaly/dist/patternomaly.js"}],"src/addFallbackText.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addFallbackText = addFallbackText;

/**
 * add fallback text to HTML canvas element for chart
 * @param {object} chart_obj Chart.js instance
 */
function addFallbackText(chart_obj) {
  var title = "Untitled";
  ...
  var type = chart_obj.config.type;

  if (chart_obj.canvas instanceof HTMLCanvasElement) {
    chart_obj.canvas.innerText = "".concat(title, ". Alternative format for this ").concat(type, " chart is above.");
  } else {
 ...
 */
function genStats(chart_obj) {
  // In future will get different stats depending on type property
  var statsObjs = []; // TODO: handle floats

  chart_obj.data.datasets.forEach(function (dataset) {
    var datasetStats = {
      label: dataset.label,
      max_value: Math.max.apply(Math, _toConsumableArray(dataset.data)),
      max_value_labels: [],
      min_value: Math.min.apply(Math, _toConsumableArray(dataset.data)),
      min_value_labels: []
    };
    dataset.data.forEach(function (value, index) {
      if (value === datasetStats.max_value) {
        var corresponding_label = chart_obj.data.labels[index];
        datasetStats.max_value_labels.push(corresponding_label);
      }

      if (value === datasetStats.min_value) {
        var _corresponding_label = chart_obj.data.labels[index];
        datasetStats.min_value_labels.push(_corresponding_label);
      }
    });
...
function arrayToString(labels_array) {
  var labels_string = "";

  if (labels_array.length > 1) {
    // add an "and" second to last
    labels_array.splice(labels_array.length - 1, 0, "and"); // fix summary statement syntax
...
function spellInt(int) {
  var arry_one_to_ten = ["one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten"];

  if (int > 0 && int < 11) {
    return arry_one_to_ten[int - 1];
  }
}
},{}],"src/createTable.js":[function(require,module,exports) {
"use strict";
...
exports.createOverview = createOverview;
exports.createThead = createThead;
exports.createTbody = createTbody;
exports.createTr_data = createTr_data;
 ...
 */
function createTable(chart_obj) {
  var overview = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  ...
  */
  ...
  var caption = createCaption(chart_obj, overview); // pass subdata to create or not create a subdata col

  var thead = createThead(chart_obj.data.labels, subdata);
  var tbody = createTbody(chart_obj.data.datasets, subdata);
...
function createCaption(chart_obj) {
  var overview = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  ...
  var type = chart_obj.config.type;
  var num_datasets = chart_obj.data.datasets.length;
  var num_d_s = num_datasets;

  if (num_datasets <= 10) {
    num_d_s = (0, _utils.spellInt)(num_datasets);
  }

  var num_datasets_s = '';

  if (num_datasets > 1) {
    num_datasets_s = "".concat(num_d_s, " datasets");
  } else {
    num_datasets_s = "".concat(num_d_s, " dataset");
  }

  var num_labels = chart_obj.data.labels.length;
  var num_l_s = num_labels;

  if (num_labels <= 10) {
    num_l_s = (0, _utils.spellInt)(num_labels);
  }

  var num_labels_s = '';

  if (num_labels > 1) {
    num_labels_s = "".concat(num_l_s, " categories");
  } else {
    num_labels_s = "".concat(num_l_s, " category");
  }

  caption.innerHTML = "Alternative format for ".concat(type, " chart, <span class=\"alt-title\">").concat(title, "</span>. Table shows ").concat(num_datasets_s, " and ").concat(num_labels_s, ".");

  if (overview) {
    if (chart_obj.data.datasets.length <= 4) {
      var span = createOverview(chart_obj);
      caption.append(span);
    } else {
...
function createOverview(chart_obj) {
  var span = document.createElement("span");
  span.classList.add("overview");
  var statsObjs = (0, _utils.genStats)(chart_obj); //let summary_stats_s = '';
  ...
  var summary_stats_arry = statsObjs.map(function (object) {
    var max_labels_s = (0, _utils.arrayToString)(object.max_value_labels);
    var min_labels_s = (0, _utils.arrayToString)(object.min_value_labels);
    var substring = '';

    if (statsObjs.length > 1) {
      substring = "for \"".concat(object.label, "\" ");
    }

    return "\n      Max and min values ".concat(substring, "are ").concat(object.max_value, " (").concat(max_labels_s, ") and ").concat(object.min_value, " (").concat(min_labels_s, "), respectively.\n      ");
    /*
    return `
  ...
  var span_stats = summary_stats_arry.map(function (stat) {
    var span = document.createElement("span");
  ...
  span_stats.forEach(function (span_stat) {
...
function createThead(labels, subdata) {
  var thead = document.createElement("thead");
  var tr = document.createElement("tr"); // create empty col if subdata is true
...
function createTbody(datasets, subdata) {
  // TODO: add checks
  ...
  try {
    for (var _iterator2 = datasets[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      var tr_data = createTr_data(dataset, subdata);
...
function createTr_data(dataset, subdata) {
  var tr_data = document.createElement("tr");

  if (subdata) {
    var th = createTh(dataset.label, true);
    tr_data.append(th);
  } // fill in data row
  ...
  try {
    for (var _iterator3 = dataset.data[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
function createTh(label) {
  var row = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
},{"./utils":"src/utils.js"}],"src/createToggleView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createToggleView = createToggleView;
exports.createToggleViewBtn = createToggleViewBtn;
 ...
 */
function createToggleView(canvas_el, table_el) {
  var article = document.createElement("article");
  article.classList.add("toggle-view");
  var button = createToggleViewBtn();
...
function toggleView(e) {
  ...
  var inner = e.target.previousSibling; // get .alt-container element within inner element and toggle chart-alt-back and chart-alt-front

  var alt = inner.querySelector(".alt-container");
  alt.classList.toggle("chart-alt-back");
  alt.classList.toggle("chart-alt-front"); // do same for canvas el

  var canvas = inner.querySelector("canvas");
  canvas.classList.toggle("chart-alt-back");
  canvas.classList.toggle("chart-alt-front");
}
},{}],"src/addChartAlt.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addChartAlt = addChartAlt;

var _addFallbackText = require("./addFallbackText");

var _createTable = require("./createTable");

var _createToggleView = require("./createToggleView");
...
function addChartAlt(chart) {
  ...
  if (chart.config.type !== "bar") {
    ...
    var canvasParent = chart.canvas.parentNode;
    var article = document.createElement("article");
    article.classList.add("chart-alt"); // add second article el above canvas

    var article2 = document.createElement("article");
    article2.classList.add("chart-alt-inner");
    article.append(article2);
    canvasParent.insertBefore(article, chart.canvas); // add fall back text to canvas

    (0, _addFallbackText.addFallbackText)(chart); // add front class to canvas

    chart.canvas.classList.add("chart-alt-front"); // create table using data in chart.config and overview option

    var alt = (0, _createTable.createTable)(chart, overview);
    var altContainer = document.createElement("div");
    altContainer.classList.add("alt-container", "chart-alt-back");
    altContainer.append(alt); //article.append(altContainer, chart.canvas);

    article2.append(altContainer, chart.canvas); // if toggle, add chart-alt-toggle class and add button 

    if (toggle) {
      article.classList.add("chart-alt-toggle");
      var toggleViewBtn = (0, _createToggleView.createToggleViewBtn)(); //article.insertBefore(toggleViewBtn, altContainer);

      article.append(toggleViewBtn);
    }
  }
}
},{"./addFallbackText":"src/addFallbackText.js","./createTable":"src/createTable.js","./createToggleView":"src/createToggleView.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _styles_doc = _interopRequireDefault(require("./src/styles_doc.css"));

require("./src/styles_chartAlt.css");

var _chart = _interopRequireDefault(require("chart.js"));

var _barChart = require("./src/barChart.js");

var _addChartAlt = require("./src/addChartAlt");
...
var chart1 = new _chart.default(ctx1, _barChart.coffeeChart_2_6);
(0, _addChartAlt.addChartAlt)(chart1);
/* #chart2 */

var ctx2 = document.getElementById('chart2').getContext('2d');
var chart2 = new _chart.default(ctx2, _barChart.coffeeChart_2_6);
(0, _addChartAlt.addChartAlt)(chart2, true);
/* #test3 
...
*/
},{"./src/styles_doc.css":"src/styles_doc.css","./src/styles_chartAlt.css":"src/styles_chartAlt.css","chart.js":"node_modules/chart.js/src/chart.js","./src/barChart.js":"src/barChart.js","./src/addChartAlt":"src/addChartAlt.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/chart-alt.e31bb0bc.js.map